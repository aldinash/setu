...
void GetWriteHandleResponse::Serialize(BinaryBuffer& buffer) const {
  BinaryWriter writer(buffer);
  writer.WriteFields(request_id, error_code, tensor_ipc_spec);
}

GetWriteHandleResponse GetWriteHandleResponse::Deserialize(
  ...
  return GetWriteHandleResponse(request_id_val, error_code_val,
