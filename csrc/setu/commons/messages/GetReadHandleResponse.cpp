...
void GetReadHandleResponse::Serialize(BinaryBuffer& buffer) const {
  BinaryWriter writer(buffer);
  writer.WriteFields(request_id, error_code, tensor_ipc_spec);
}

GetReadHandleResponse GetReadHandleResponse::Deserialize(
  ...
  return GetReadHandleResponse(request_id_val, error_code_val,
